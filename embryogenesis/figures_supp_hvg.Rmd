---
title: "Supplementary figure - HVG - embryogenesis"
...
gene_sets <- readRDS(file = "other_rds_files/gene_sets500.Rds")

gene_sets[["HVG(Yan)"]] <- BrenneckeGetVariableGenes(normcounts(yan))[["Gene"]][1:500]

```


```{r}
gene_sets[["HVG(Deng)"]] <- BrenneckeGetVariableGenes(counts(deng))[["Gene"]][1:500]
...
```{r}
ggsave(filename = "embryo_devel_MDS_HVG.eps",
       device = "eps", 
